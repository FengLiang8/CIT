...
# ========== Load Model ==========
def load_model(model_name, sft_model_dir):
...
def main():
    ...
    parser.add_argument("--sft_model_dir", type=str, required=True, help="sft model checpoint")
    args = parser.parse_args()

    logging.set_verbosity_error()
    model, tokenizer = load_model(args.model, args.sft_model_dir)
